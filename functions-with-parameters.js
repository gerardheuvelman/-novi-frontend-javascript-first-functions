...
function minutesToSEconds(munMinutes){
  return munMinutes * 60;
}
...
function calculateDogYears(dogYears){
  console.log('Jouw hond is '  + dogYears * 7 +' jaar oud in mensenjaren.')
}
calculateDogYears(6)
calculateDogYears(62)
